define(['exports', 'metal/src/metal', 'metal-dom/src/all/dom', 'metal-state/src/State', 'metal-events/src/events', 'metal-position/src/all/position'], function (exports, _metal, _dom, _State2, _events, _position) {
	'use strict';
