define(['exports', 'metal/src/metal', 'metal-dom/src/all/dom', 'metal-position/src/all/position', 'metal-state/src/all/state', 'metal-jquery-adapter/src/JQueryAdapter'], function (exports, _metal, _dom, _position, _state, _JQueryAdapter) {
	'use strict';
