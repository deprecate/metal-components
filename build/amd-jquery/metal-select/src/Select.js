define(['exports', 'metal/src/metal', 'metal-dom/src/all/dom', './Select.soy', 'metal-jquery-adapter/src/JQueryAdapter', 'metal-dropdown/src/Dropdown'], function (exports, _metal, _dom, _Select, _JQueryAdapter) {
	'use strict';
